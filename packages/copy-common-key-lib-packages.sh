...
cp --preserve=timestamps -f ../openssl/lib*-i686.pkg.tar.zst ./common-key-lib_MSYS_32bit_packages/
cp --preserve=timestamps -f ../openssl/openssl-devel*-i686.pkg.tar.zst ./common-key-lib_MSYS_32bit_packages/
